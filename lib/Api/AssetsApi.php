...
class AssetsApi
{
     ...
     * @return \SparteraApiSdk\Model\AnalyzeCompanyHandleAssetsAssetSlugGet200Response|\SparteraApiSdk\Model\InlineObject1|\SparteraApiSdk\Model\InlineObject2|\SparteraApiSdk\Model\InlineObject3
     */
     ...
     * @throws \SparteraApiSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \SparteraApiSdk\Model\AnalyzeCompanyHandleAssetsAssetSlugGet200Response|\SparteraApiSdk\Model\InlineObject1|\SparteraApiSdk\Model\InlineObject2|\SparteraApiSdk\Model\InlineObject3, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\SparteraApiSdk\Model\AnalyzeCompanyHandleAssetsAssetSlugGet200Response',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\SparteraApiSdk\Model\AnalyzeCompanyHandleAssetsAssetSlugGet200Response';
        $request = $this->analyzeCompanyHandleAssetsAssetSlugGetRequest($asset_slug, $company_handle, $contentType);
     ...
     * @param  string $company_id company_id (required)
     * @param  string $asset_id asset_id (required)
     * @param  \SparteraApiSdk\Model\AssetsUpdate $assets_update assets_update (required)
     ...
     */
    public function companiesCompanyIdAssetsAssetIdPatch($company_id, $asset_id, $assets_update, string $contentType = self::contentTypes['companiesCompanyIdAssetsAssetIdPatch'][0])
    {
        list($response) = $this->companiesCompanyIdAssetsAssetIdPatchWithHttpInfo($company_id, $asset_id, $assets_update, $contentType);
        return $response;
    }
     ...
     * @param  string $company_id (required)
     * @param  string $asset_id (required)
     * @param  \SparteraApiSdk\Model\AssetsUpdate $assets_update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['companiesCompanyIdAssetsAssetIdPatch'] to see the possible values for this operation
     *
     * @throws \SparteraApiSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function companiesCompanyIdAssetsAssetIdPatchWithHttpInfo($company_id, $asset_id, $assets_update, string $contentType = self::contentTypes['companiesCompanyIdAssetsAssetIdPatch'][0])
    {
        $request = $this->companiesCompanyIdAssetsAssetIdPatchRequest($company_id, $asset_id, $assets_update, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companiesCompanyIdAssetsAssetIdPatchAsync($company_id, $asset_id, $assets_update, string $contentType = self::contentTypes['companiesCompanyIdAssetsAssetIdPatch'][0])
    {
        return $this->companiesCompanyIdAssetsAssetIdPatchAsyncWithHttpInfo($company_id, $asset_id, $assets_update, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companiesCompanyIdAssetsAssetIdPatchAsyncWithHttpInfo($company_id, $asset_id, $assets_update, string $contentType = self::contentTypes['companiesCompanyIdAssetsAssetIdPatch'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function companiesCompanyIdAssetsAssetIdPatchRequest($company_id, $asset_id, $assets_update, string $contentType = self::contentTypes['companiesCompanyIdAssetsAssetIdPatch'][0])
    {
        ...
        if ($assets_update === null || (is_array($assets_update) && count($assets_update) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $assets_update when calling companiesCompanyIdAssetsAssetIdPatch'
            );
        }
     ...
     *
     * @param  string $company_id company_id (required)
     * @param  \SparteraApiSdk\Model\AssetsInput $assets_input assets_input (required)
     ...
     */
    public function companiesCompanyIdAssetsPost($company_id, $assets_input, string $contentType = self::contentTypes['companiesCompanyIdAssetsPost'][0])
    {
        list($response) = $this->companiesCompanyIdAssetsPostWithHttpInfo($company_id, $assets_input, $contentType);
        return $response;
    }
     ...
     *
     * @param  string $company_id (required)
     * @param  \SparteraApiSdk\Model\AssetsInput $assets_input (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['companiesCompanyIdAssetsPost'] to see the possible values for this operation
     *
     * @throws \SparteraApiSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function companiesCompanyIdAssetsPostWithHttpInfo($company_id, $assets_input, string $contentType = self::contentTypes['companiesCompanyIdAssetsPost'][0])
    {
        $request = $this->companiesCompanyIdAssetsPostRequest($company_id, $assets_input, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companiesCompanyIdAssetsPostAsync($company_id, $assets_input, string $contentType = self::contentTypes['companiesCompanyIdAssetsPost'][0])
    {
        return $this->companiesCompanyIdAssetsPostAsyncWithHttpInfo($company_id, $assets_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companiesCompanyIdAssetsPostAsyncWithHttpInfo($company_id, $assets_input, string $contentType = self::contentTypes['companiesCompanyIdAssetsPost'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function companiesCompanyIdAssetsPostRequest($company_id, $assets_input, string $contentType = self::contentTypes['companiesCompanyIdAssetsPost'][0])
    {
        ...
        if ($assets_input === null || (is_array($assets_input) && count($assets_input) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $assets_input when calling companiesCompanyIdAssetsPost'
            );
        }
