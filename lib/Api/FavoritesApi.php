...
class FavoritesApi
{
     ...
     * @return \SparteraApiSdk\Model\CompaniesCompanyIdUsersUserIdFavoritesCategoryCategoryGet200Response|\SparteraApiSdk\Model\InlineObject1|\SparteraApiSdk\Model\InlineObject2|\SparteraApiSdk\Model\InlineObject3
     */
     ...
     * @throws \SparteraApiSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \SparteraApiSdk\Model\CompaniesCompanyIdUsersUserIdFavoritesCategoryCategoryGet200Response|\SparteraApiSdk\Model\InlineObject1|\SparteraApiSdk\Model\InlineObject2|\SparteraApiSdk\Model\InlineObject3, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\SparteraApiSdk\Model\CompaniesCompanyIdUsersUserIdFavoritesCategoryCategoryGet200Response',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\SparteraApiSdk\Model\CompaniesCompanyIdUsersUserIdFavoritesCategoryCategoryGet200Response';
        $request = $this->companiesCompanyIdUsersUserIdFavoritesCategoryCategoryGetRequest($company_id, $user_id, $category, $contentType);
     ...
     * @param  string $user_id user_id (required)
     * @param  string $favorite_id favorite_id (required)
     * @param  \SparteraApiSdk\Model\FavoritesUpdate $favorites_update favorites_update (required)
     ...
     */
    public function companiesCompanyIdUsersUserIdFavoritesFavoriteIdPatch($company_id, $user_id, $favorite_id, $favorites_update, string $contentType = self::contentTypes['companiesCompanyIdUsersUserIdFavoritesFavoriteIdPatch'][0])
    {
        list($response) = $this->companiesCompanyIdUsersUserIdFavoritesFavoriteIdPatchWithHttpInfo($company_id, $user_id, $favorite_id, $favorites_update, $contentType);
        return $response;
    }
     ...
     * @param  string $user_id (required)
     * @param  string $favorite_id (required)
     * @param  \SparteraApiSdk\Model\FavoritesUpdate $favorites_update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['companiesCompanyIdUsersUserIdFavoritesFavoriteIdPatch'] to see the possible values for this operation
     *
     * @throws \SparteraApiSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function companiesCompanyIdUsersUserIdFavoritesFavoriteIdPatchWithHttpInfo($company_id, $user_id, $favorite_id, $favorites_update, string $contentType = self::contentTypes['companiesCompanyIdUsersUserIdFavoritesFavoriteIdPatch'][0])
    {
        $request = $this->companiesCompanyIdUsersUserIdFavoritesFavoriteIdPatchRequest($company_id, $user_id, $favorite_id, $favorites_update, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companiesCompanyIdUsersUserIdFavoritesFavoriteIdPatchAsync($company_id, $user_id, $favorite_id, $favorites_update, string $contentType = self::contentTypes['companiesCompanyIdUsersUserIdFavoritesFavoriteIdPatch'][0])
    {
        return $this->companiesCompanyIdUsersUserIdFavoritesFavoriteIdPatchAsyncWithHttpInfo($company_id, $user_id, $favorite_id, $favorites_update, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companiesCompanyIdUsersUserIdFavoritesFavoriteIdPatchAsyncWithHttpInfo($company_id, $user_id, $favorite_id, $favorites_update, string $contentType = self::contentTypes['companiesCompanyIdUsersUserIdFavoritesFavoriteIdPatch'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function companiesCompanyIdUsersUserIdFavoritesFavoriteIdPatchRequest($company_id, $user_id, $favorite_id, $favorites_update, string $contentType = self::contentTypes['companiesCompanyIdUsersUserIdFavoritesFavoriteIdPatch'][0])
    {
        ...
        if ($favorites_update === null || (is_array($favorites_update) && count($favorites_update) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $favorites_update when calling companiesCompanyIdUsersUserIdFavoritesFavoriteIdPatch'
            );
        }
     ...
     * @param  string $company_id company_id (required)
     * @param  string $user_id user_id (required)
     * @param  \SparteraApiSdk\Model\FavoritesInput $favorites_input favorites_input (required)
     ...
     */
    public function companiesCompanyIdUsersUserIdFavoritesPost($company_id, $user_id, $favorites_input, string $contentType = self::contentTypes['companiesCompanyIdUsersUserIdFavoritesPost'][0])
    {
        list($response) = $this->companiesCompanyIdUsersUserIdFavoritesPostWithHttpInfo($company_id, $user_id, $favorites_input, $contentType);
        return $response;
    }
     ...
     * @param  string $company_id (required)
     * @param  string $user_id (required)
     * @param  \SparteraApiSdk\Model\FavoritesInput $favorites_input (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['companiesCompanyIdUsersUserIdFavoritesPost'] to see the possible values for this operation
     *
     * @throws \SparteraApiSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function companiesCompanyIdUsersUserIdFavoritesPostWithHttpInfo($company_id, $user_id, $favorites_input, string $contentType = self::contentTypes['companiesCompanyIdUsersUserIdFavoritesPost'][0])
    {
        $request = $this->companiesCompanyIdUsersUserIdFavoritesPostRequest($company_id, $user_id, $favorites_input, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companiesCompanyIdUsersUserIdFavoritesPostAsync($company_id, $user_id, $favorites_input, string $contentType = self::contentTypes['companiesCompanyIdUsersUserIdFavoritesPost'][0])
    {
        return $this->companiesCompanyIdUsersUserIdFavoritesPostAsyncWithHttpInfo($company_id, $user_id, $favorites_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function companiesCompanyIdUsersUserIdFavoritesPostAsyncWithHttpInfo($company_id, $user_id, $favorites_input, string $contentType = self::contentTypes['companiesCompanyIdUsersUserIdFavoritesPost'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function companiesCompanyIdUsersUserIdFavoritesPostRequest($company_id, $user_id, $favorites_input, string $contentType = self::contentTypes['companiesCompanyIdUsersUserIdFavoritesPost'][0])
    {
        ...
        if ($favorites_input === null || (is_array($favorites_input) && count($favorites_input) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $favorites_input when calling companiesCompanyIdUsersUserIdFavoritesPost'
            );
        }
