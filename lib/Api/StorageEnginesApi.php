...
class StorageEnginesApi
{
     ...
     * @return \SparteraApiSdk\Model\CloudProvidersProviderIdStorageEnginesGet200Response|\SparteraApiSdk\Model\InlineObject1|\SparteraApiSdk\Model\InlineObject2|\SparteraApiSdk\Model\InlineObject3
     */
     ...
     * @throws \SparteraApiSdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \SparteraApiSdk\Model\CloudProvidersProviderIdStorageEnginesGet200Response|\SparteraApiSdk\Model\InlineObject1|\SparteraApiSdk\Model\InlineObject2|\SparteraApiSdk\Model\InlineObject3, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\SparteraApiSdk\Model\CloudProvidersProviderIdStorageEnginesGet200Response',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\SparteraApiSdk\Model\CloudProvidersProviderIdStorageEnginesGet200Response';
        $request = $this->cloudProvidersProviderIdStorageEnginesEngineIdGetRequest($provider_id, $engine_id, $contentType);
