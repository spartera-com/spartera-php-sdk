...
/**
 * AssetPriceHistoryUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class AssetPriceHistoryUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AssetPriceHistoryUpdate';
     ...
     * Sets asset_id
     *
     * @param string|null $asset_id FK to assets. NULL when this record belongs to an endpoint.
     *
     * @return self
     */
     ...
     * Sets endpoint_id
     *
     * @param string|null $endpoint_id FK to endpoints. NULL when this record belongs to an asset.
     *
     * @return self
     */
     ...
     * Sets price_usd
     *
     * @param float|null $price_usd Optional.
     *
     * @return self
     */
     ...
     * Sets date_ended
     *
     * @param \DateTime|null $date_ended SCD Type 2 — when this price record was superseded
     *
     * @return self
     */
