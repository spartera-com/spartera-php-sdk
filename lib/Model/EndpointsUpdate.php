...
/**
 * EndpointsUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class EndpointsUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EndpointsUpdate';
     ...
     * Sets connection_id
     *
     * @param string|null $connection_id Connection to the data source
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Human-readable name for the endpoint
     *
     * @return self
     */
