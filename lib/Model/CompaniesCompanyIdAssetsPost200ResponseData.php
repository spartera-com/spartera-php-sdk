...
/**
 * CompaniesCompanyIdAssetsPost200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  SparteraApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class CompaniesCompanyIdAssetsPost200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_companies__company_id__assets_post_200_response_data';
    ...
    */
     ...
     * Sets asset_id
     *
     * @param string $asset_id ID of the created assets
     *
     * @return self
     */
