...
class Endpoints implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['price_credits'] === null) {
            $invalidProperties[] = "'price_credits' can't be null";
        }
     ...
     * Sets price_credits
     *
     * @param int $price_credits Credits deducted from the buyer's pool per successful (200 OK) request. Same credit pool as assets. price_usd kept for billing records / dashboards.
     *
     * @return self
     */
