...
/**
 * DeletePostgenIntegrations200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeletePostgenIntegrations200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'deletePostgenIntegrations_200_response_data';
     ...
     * Sets integration_id
     *
     * @param string $integration_id ID of the deleted postgen_integrations
     *
     * @return self
     */
