...
/**
 * CreatePostgenIntegrations200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreatePostgenIntegrations200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createPostgenIntegrations_200_response_data';
     ...
     * Sets integration_id
     *
     * @param string $integration_id ID of the created postgen_integrations
     *
     * @return self
     */
