...
/**
 * CompaniesUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class CompaniesUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CompaniesUpdate';
     ...
     * Sets company_handle
     *
     * @param string|null $company_handle Required. Must be unique.
     *
     * @return self
     */
     ...
     * Sets company_domain
     *
     * @param string|null $company_domain Required. Must be unique.
     *
     * @return self
     */
     ...
     *
     * @param int|null $credits_balance Current balance of credits for this company (buyer)
     *
     * @return self
     */
