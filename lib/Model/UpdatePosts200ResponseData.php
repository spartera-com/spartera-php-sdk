...
/**
 * UpdatePosts200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdatePosts200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'updatePosts_200_response_data';
     ...
     * Sets post_id
     *
     * @param string $post_id ID of the updated posts
     *
     * @return self
     */
