 ...
 *
 * @category Class
 * @description Secure connections from Spartera to your databases and data warehouses
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Connections implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets connection_id
     *
     * @param string|null $connection_id Unique identifier.
     *
     * @return self
     */
     ...
     * Sets engine_id
     *
     * @param int $engine_id References storage_engines.engine_id — Fact table of all the different storage engines we support. See GET /storage_engines for valid values. Required.
     *
     * @return self
     */
     ...
     *
     * @param string|null $provider_domain Domain of the external API provider (e.g., 'api.weather.com')
     *
     * @return self
     */
     ...
     *
     * @param bool|null $verified_usage_ability Optional.
     *
     * @return self
     */
