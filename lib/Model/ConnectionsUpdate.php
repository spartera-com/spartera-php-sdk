...
/**
 * ConnectionsUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class ConnectionsUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ConnectionsUpdate';
     ...
     * Sets engine_id
     *
     * @param int|null $engine_id References storage_engines.engine_id — Fact table of all the different storage engines we support. See GET /storage_engines for valid values. Required.
     *
     * @return self
     */
