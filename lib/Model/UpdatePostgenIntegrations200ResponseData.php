...
/**
 * UpdatePostgenIntegrations200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdatePostgenIntegrations200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'updatePostgenIntegrations_200_response_data';
     ...
     * Sets integration_id
     *
     * @param string $integration_id ID of the updated postgen_integrations
     *
     * @return self
     */
