...
/**
 * CompaniesCompanyIdUsersUserIdAlertsPost200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  SparteraApiSdk
 * @author   OpenAPI Generator team
 ...
 */
class CompaniesCompanyIdUsersUserIdAlertsPost200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_companies__company_id__users__user_id__alerts_post_200_response_data';
    ...
    */
     ...
     * Sets alert_id
     *
     * @param string $alert_id ID of the created alerts
     *
     * @return self
     */
